				...
				if (jyuuosenai == 0) {
					...
					{//「右」は今押された
					  //「右」が押されたときの処理
						...
						DOWNbotannlock = 1;
						if (migimuki == 1) {
							if (pos[enemyY][enemyX][1] + 20 + playerattackhanndou3 > pos[playerY][playerX][1] + nanameidouY + nanameidouY2 + nanameidouY3 + nanameidouY4 + nanameidouY5 &&
								...
								&& pos[enemyY][enemyX][0] + playerattackhanndou + playerattackhanndou2 + playerattackhanndou3 > pos[playerY][playerX][0] + nanameidouX + migiidou + nanameidouX2 + nanameidouX3 + nanameidouX4 + nanameidouX5 + yokeruX - 15
				...
				if (lock == 0) {
						...
						)
					{
						if (
							...
							++MGtime;
							StartJoypadVibration(DX_INPUT_PAD1, 1800, MGcount);
							if (pos[enemyY][enemyX][1] + 25 + playerattackhanndou3 > pos[playerY][playerX][1] + nanameidouY + nanameidouY2 + nanameidouY3 + nanameidouY4 + nanameidouY5 &&
								pos[enemyY][enemyX][1] - 25 + playerattackhanndou3 < pos[playerY][playerX][1] + nanameidouY + nanameidouY2 + nanameidouY3 + nanameidouY4 + nanameidouY5
